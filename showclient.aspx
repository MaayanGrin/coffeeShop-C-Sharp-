<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showclient.aspx.cs" Inherits="showclient" %>
    ...
    <script>
      var url = "Handler.ashx";
        ...
        function buildT1() {
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                if (myJSON_Text != "]") {
                    ...
                    while (obj[i] != null) {
                        ...
                        td3.innerHTML += "<a href='#' color='blue' onclick='editC(" + x + "); return false;'>Edit</a>";
                        tr.appendChild(td3);
                        var td4 = document.createElement("td");
                        td4.innerHTML += "<a href='#' color='blue' onclick='DELC(" + x + "); return false;'>Delete</a>";
                        tr.appendChild(td4);
            ...
            function DELC(x) {
            var url2 = url + "?cmd=Delc&username=" + x;
            xmlHttp.open("GET", url2, true);
        ...
        function editC1() {
            ...
            if (firstname == "" || lastname == "" || email == "" || password == "") {
                ...
                if (!check) {
                    ...
                    var url2 = url + "?cmd=editc&newfname=" + firstname + "&newlname=" + lastname + "&newusername=" + username + "&newemial=" + email + "&newpassword=" + password ;
                    xmlHttp.open("GET", url2, true);
...
<body onload="onLoadJavaScript()">
    <form id="form1" runat="server">
        ...
        <div id="content_area">
            ...
            <h1><b style="font-size:14px;">List Users</b></h1>
