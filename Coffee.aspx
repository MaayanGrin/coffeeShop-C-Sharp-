<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Coffee.aspx.cs" Inherits="Coffee" %>
...
<head runat="server">
    ...
    <script>
        ...
        function createTablecoffee() {
            var url2 = url + "?cmd=createTablecoffee";
...
<div >
        ...
        <h1><b style="font-size:14px;">Coffee menu</b></h1>
